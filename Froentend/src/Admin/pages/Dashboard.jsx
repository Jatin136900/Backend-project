...
function AddProduct() {
  ...
  async function checkSlug(e) {
    const response = await axios.get(
      "http://localhost:3000/product/checkSlug/" + e.target.value,
          ...
          >
            ...
            <div className="md:col-span-2 flex flex-col">
              ...
              <textarea
                ...
                onChange={handleChange}
                className="border rounded-lg px-3 py-2 h-28 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500"
              ></textarea>
            </div>
            ...
            <div className="md:col-span-2 flex justify-center">
              <button
                type="submit"
                className="bg-blue-600 cursor-pointer text-white px-6 py-3 rounded-lg shadow hover:bg-blue-700 transition-all w-full md:w-1/2"
              >
                Add Product
              </button>
            </div>
